...
// Answer: 6 times '6' each at the gap of 1s
...
// Answer: 6 times 'interview' and then numbers from 0 till 5 after every 1sec.
...
let copied = person;
let elements = ["name", "age", "isAutherised", "isUnicorn", "bestDomain"];
console.log(copied);
for(var i = 0; i<5; i++){
    console.log(copied[elements[i]]);
}
